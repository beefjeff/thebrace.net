...
<template>
    ...
    <!-- Edit Client Modal -->
    <div class="modal" id="modal-edit-client" tabindex="-1" role="dialog" :class="[editClientModal ? 'is-active' : '']">
        <div class="modal-background"></div>
        <div class="modal-card">
            <div class="modal-card-head">
            ...
            <div class="modal-card-body">
                ...
                <!-- Modal Actions -->
                <div class="modal-card-foot">
                    <button type="button" class="btn btn-default" @click="closeEditClientModal">Close</button>
